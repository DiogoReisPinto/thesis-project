...
For this areas of interest, CMMI defines 22 core process areas, covering processes that are fundamental to improve the organization's processes. Each one of the areas is a set of related practices that, when implemented, will achieve goals important for process improvement. The process areas are presented in Appendix section X.\par
...
The leaders quadrant is composed by Planview with the product Planview Enterprise, Compuware with ChangePoint, CA with CA Clarity EPM, HP with HP PPM Center, Microsoft with EPM and Oracle with Primavera. In Appendix, section X, we present the main strengths and cautions for each one of this solutions, based on Gartner's analysis.
