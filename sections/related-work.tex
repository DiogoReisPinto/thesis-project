...
\subsubsection{CMMI and its importance for COBT 5}

CMMI (Capability Maturity Model Integration), first developed at the Software Engineering Institute at Carnegie Mellon University and currently operated by the CMMI Institute, consists on a set of practices and process improvement goals that organizations can use to evaluate and improve its processes. 
CMMI, currently on version 1.3, defines process areas considering business objectives. The three areas of interest for CMMI are:
